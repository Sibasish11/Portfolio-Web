        ...
        <div className="hero">
            <div className="hSection left">
                ...
                <motion.div
                    ...
                    className="awards"
                >
                    <motion.h2 variants={awardVariants}>AI & Software Development Enthusiast</motion.h2>
                    <motion.p variants={awardVariants}>Building a strong foundation in software engineering with hands-on experience in modern development tools and technologies.</motion.p>
