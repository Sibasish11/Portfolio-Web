        ...
        <div className="contact" ref={ref}>
            <div className="cSection">
                <motion.form
                    ...
                    <motion.div variants={listVariant} className="formItem">
                        <label>Message</label>
                        <textarea name="user_message" placeholder="Write your message..." rows="20"></textarea>
                    </motion.div>
                    <motion.button variants={listVariant} className="formButton">Send Message</motion.button>
